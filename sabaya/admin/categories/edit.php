...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $nom = trim($_POST['nom']);
    $imageName = $categorie['image']; // Keep existing image by default
    ...
    // Check for duplicate name, excluding the current category (same approach as product validation)
    if (empty($errors)) {
        $existing = $categoryModel->findByName($nom);
        if ($existing && (int)$existing['id_categorie'] !== $id) {
    ...
    if (empty($errors)) {
        $categoryModel->update($id, $nom, $imageName);

        // Flash message success/failure
        $_SESSION['flash_success'] = "La catégorie \"" . $nom . "\" a été mise à jour avec succès.";
        header('Location: list.php');
        exit();
    }
}
...
<head>
    ...
    <title>Modifier une Catégorie | Sabaya Luxury Admin</title>
    ...
    <div class="admin-main-wrapper">
        ...
        <header class="admin-top-header">
            ...
            <div class="header-title-block">
                ...
                <p class="header-subtitle">Mettez à jour les informations de la catégorie.</p>
            </div>
        ...
        <main class="admin-content">
            <section aria-label="Formulaire de modification de catégorie">
                    ...
                    <div class="form-grid">
                        ...
                        <fieldset class="form-card">
                            ...
                            <div class="form-group">
                                ...
                                <!-- Pre-populate all form fields using the same technique as product edit -->
                                <input type="text" id="nom" name="nom" required placeholder="Ex: Abayas Casual" value="<?= htmlspecialchars($categorie['nom']) ?>">
                            </div>
                        </fieldset>

                        <!-- RIGHT COLUMN: Image Catégorie -->
                            ...
                            <div class="image-preview-wrapper" id="preview-container">
                                ...
                                <div class="image-preview-container">
                                    <?php if (!empty($categorie['image'])): ?>
                                        <img id="image-preview" src="../../assets/images/categories/<?= htmlspecialchars($categorie['image']) ?>" alt="Aperçu de l'image de la catégorie" class="image-preview">
